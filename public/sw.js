const CACHE='monthly-expense-v5-1-ocr';
...
self.addEventListener('fetch',e=>{
  const r=e.request;if(r.method!=='GET')return;const u=new URL(r.url),cacheable=u.origin===self.location.origin||/cdn\.jsdelivr\.net$|unpkg\.com$|esm\.sh$|huggingface\.co$|paddle-model-ecology\.bj\.bcebos\.com$/.test(u.hostname);if(!cacheable)return;
